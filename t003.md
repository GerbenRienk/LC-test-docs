...
**expected results:**  
At the top of the list should be your login and the logout just before that, both with the correct date-time. Bear in mind that the date-time of the server are used.
